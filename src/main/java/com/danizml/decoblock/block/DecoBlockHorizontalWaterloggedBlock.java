...
public abstract class DecoBlockHorizontalWaterloggedBlock extends DecoBlockWaterloggedBlock{
    public static final DirectionProperty DIRECTION = BlockStateProperties.HORIZONTAL_FACING;

    public DecoBlockHorizontalWaterloggedBlock(Properties properties) {
        super(properties);
    }
